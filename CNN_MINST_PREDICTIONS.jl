...
# ╔═╡ 25ca531e-944e-4c16-9d83-a68fe9df5656
begin
...
# ╔═╡ c0646bc8-92fa-11ef-01fc-0d421d92d2ed
begin
	BSON.@load "/home/dawid/Documents/studia/KONWERSATORIUM NOWOCZESNYCH TECHNIK ANALITYCZNYCH /project/model.bson" model
end

# ╔═╡ d481d7dd-4d64-4317-a841-93b62b27cc60
md"""
## Prognozy
"""

# ╔═╡ cfa92441-a9df-4da3-98a3-4819fd196030
begin
...
# ╔═╡ 627ac867-591f-4ed2-9af1-0a4cb8e7ff7e


# ╔═╡ a09b6acf-c2c6-4873-b2fd-a8e9b4287e0f
begin
...
# ╔═╡ 1f343d51-fedc-4a9b-a55c-5fa78cb497af
begin
    pred = Array(model(test_set_full[1]))
	println(size(pred))
	print(pred[:,10_000])
...
# ╔═╡ f089eab1-aba8-420e-a3a3-7e563c162572
begin
	random_image = rand(1:10000)
	a = reshape(test_imgs[:, :, 10000], 28, 28)
	heatmap(a, color=:grays, title="Wg modelu to jest: $(pred[10000]), a oryginalna etykieta to $(test_labels[10000])")
end
...
manifest_format = "2.0"
project_hash = "e9dcd5eabb1b72b66f03362d074146c11ef9883c"
